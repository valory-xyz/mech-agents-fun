...
DEPENDENCY_TO_SERVICES = {
    ...
    "google-api-python-client": ["google_api_key"],
    "replicate": ["replicate"],
}
...
def _parse_results_file(results_file: str) -> Dict[str, Any]:
    """Parse the JSON results file written by the runner, or return empty dict if unavailable."""
...
def run_tool_in_isolated_venv(
    ...
    config = _build_runner_config(module_path, callable_name, prompts, required_env_vars)
